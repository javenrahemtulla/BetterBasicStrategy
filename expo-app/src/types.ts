...
export type RawAction =
  | 'hit' | 'stand' | 'doubleOrHit' | 'doubleOrStand'
  | 'split' | 'surrenderOrHit' | 'surrenderOrStand' | 'surrenderOrSplit'
...
export interface StatsData {
  ...
  shoesPlayed: number
  outcomeCounts: { wins: number; losses: number; pushes: number; blackjacks: number; surrenders: number }
